...
# --- Step 6: Running generated configure script
echo "Running ./configure..."
./configure || bail_out

# --- Step 7: Generate ctags for vim, if we have ctags
if [ -x /usr/bin/ctags ]
then
	echo "Generating the tags file for vim..."
	/usr/bin/ctags -R ./
fi

echo -e "\n    All done here. Now run make\n\n"
